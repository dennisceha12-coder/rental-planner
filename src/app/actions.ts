...
export async function createProject(formData: FormData) {
  ...
  const parsed = projectSchema.safeParse({
    ...
    loadInEndTime: formData.get('loadInEndTime') || undefined,
    showTime: formData.get('showTime') || undefined,
    showEndTime: formData.get('showEndTime') || undefined,
    loadOutTime: formData.get('loadOutTime') || undefined,
    loadOutEndTime: formData.get('loadOutEndTime') || undefined,
